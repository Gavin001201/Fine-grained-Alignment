...
#                                             "captions_val2017.json"]
#         if self.stuffthing:
#             self.segmentation_prefix = ("/mnt/workspace/project/gavin/taming-transformers2.0/data/cocostuffthings/train2017")
#         else:
#             self.segmentation_prefix = (
#                 "data/coco/annotations/stuff_val2017_pixelmaps" if
#                 data_json.endswith("captions_val2017.json") else
...
#             caption = caption.tolist()[0] + ' '
#             caption_all += caption
#         caption_all = caption_all.rstrip()
#         example = {"image": image,
#                    "caption": caption_all,
#                    "segmentation": segmentation,
#                    "img_path": img_path,
...
#     def __init__(self, size, onehot_segmentation=False, use_stuffthing=False, crop_size=None, force_no_crop=False):
#         super().__init__(size=size,
#                          dataroot="/mnt/workspace/project/gavin/taming-transformers2.0/data/coco/train2017",
#                          datajson="/mnt/workspace/project/gavin/taming-transformers2.0/data/coco/annotations/captions_train2017.json",
#                          onehot_segmentation=onehot_segmentation,
#                          use_stuffthing=use_stuffthing, crop_size=crop_size, force_no_crop=force_no_crop)
...
#         super().__init__(size=size,
#                          dataroot="/mnt/workspace/project/gavin/taming-transformers2.0/data/coco/train2017",
#                          datajson="/mnt/workspace/project/gavin/taming-transformers2.0/data/coco/annotations/captions_val2017.json",
#                          onehot_segmentation=onehot_segmentation,
#                          use_stuffthing=use_stuffthing, crop_size=crop_size, force_no_crop=force_no_crop,
#                          given_files=given_files)

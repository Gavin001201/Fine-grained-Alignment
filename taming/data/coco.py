...
from taming.data.sflckr import SegmentationBase # for examples included in repo
import sys
sys.path.append('/mnt/workspace/Project/Fine-grained-Alignment/data')
...
class CocoBase(Dataset):
    ...
    def __init__(self, size=None, dataroot="", datajson="", onehot_segmentation=False, use_stuffthing=False,
        ...
        assert data_json.split("/")[-1] in ["captions_train2017.json",
                                            "captions_val2017.json"]
        if self.stuffthing:
            self.segmentation_prefix = ("/mnt/workspace/Project/Fine-grained-Alignment/data/cocostuffthings/train2017")
        else:
            self.segmentation_prefix = (
                "/mnt/workspace/Project/Fine-grained-Alignment/taming/data/coco/annotations/stuff_val2017_pixelmaps" if
                data_json.endswith("captions_val2017.json") else
                "/mnt/workspace/Project/Fine-grained-Alignment/taming/data/coco/annotations/stuff_train2017_pixelmaps")
...
class CocoImagesAndCaptionsTrain(CocoBase):
    ...
    def __init__(self, size, onehot_segmentation=False, use_stuffthing=False, crop_size=None, force_no_crop=False):
        super().__init__(size=size,
                         dataroot="/mnt/workspace/Project/Fine-grained-Alignment/data/coco/train2017",
                         datajson="/mnt/workspace/Project/Fine-grained-Alignment/data/coco/annotations/captions_train2017.json",
                         onehot_segmentation=onehot_segmentation,
                         use_stuffthing=use_stuffthing, crop_size=crop_size, force_no_crop=force_no_crop)
...
class CocoImagesAndCaptionsValidation(CocoBase):
    ...
    def __init__(self, size, onehot_segmentation=False, use_stuffthing=False, crop_size=None, force_no_crop=False,
        ...
        super().__init__(size=size,
                         dataroot="/mnt/workspace/Project/Fine-grained-Alignment/data/coco/train2017",
                         datajson="/mnt/workspace/Project/Fine-grained-Alignment/data/coco/annotations/captions_val2017.json",
                         onehot_segmentation=onehot_segmentation,
                         use_stuffthing=use_stuffthing, crop_size=crop_size, force_no_crop=force_no_crop,
                         given_files=given_files)
